...
(function () {
  ...
  function computeIndentClamp(spanEls, opBlockEl, opOldIndent, opts) {
    ...
    // three (3471 batch delete, 3800 convert, 5766 batch Tab/Shift+Tab, 6016
    ...
    // compute at 8456), and every one of them hands over a `listRunOf()`
    ...
    // refusal is NOT free either: at the drop (8456) a null clamp feeds
    // spanIndentsAreAnchored() the RAW reordered indents, and that refuses
    // 1425 of 4067 legal drops where the clamped answer refuses 1411 (the
    // measured numbers are recorded at line ~371). So a false positive here
    // costs the user up to 1411 legal batch drags, replaced by a banner —
    ...
    // visibly), while neither Tab call site (5766 batch, 6016 caret) has a
  ...
  // hideTableGrips() below nulls that at its own line 7152-7154: a teardown
  ...
  //     visible — a header-only table takes the else branch at ~7358 and
