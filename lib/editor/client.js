...
(function () {
  ...
  function computeIndentClamp(spanEls, opBlockEl, opOldIndent, opts) {
    ...
    // compute at 8504), and every one of them hands over a `listRunOf()`
    ...
    // refusal is NOT free either: at the drop (8504) a null clamp feeds
  ...
  // hideTableGrips() below nulls that at its own line 7234-7236: a teardown
  ...
  //     visible — a header-only table takes the else branch at 7454-7458 and
