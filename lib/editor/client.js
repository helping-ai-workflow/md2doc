...
(function () {
  ...
  // untouched (still calls commitThenSave() directly): it is not one of the
  // three buttons backlog #6 names, driving it was out of this task's
  // scope, and wrapping it here too would risk perturbing the Finding-1/
  // Finding-3 Ctrl+S coverage this branch already has for reasons that have
  // nothing to do with the caret.
