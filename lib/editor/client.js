...
(function () {
  ...
  // clicks the degraded item and reads the banner off the page. MEASURED there:
  // that click renders UNLOCATABLE_LINE_MESSAGE, opens no textarea, and leaves
  // the file byte-identical, while the '- - a' outer of the same suite still
  // renders NO_SOURCE_LINE_MESSAGE. It is a net for a shape nobody has produced
  // yet, not a path.
