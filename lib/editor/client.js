...
(function () {
  ...
  function wireToolbarTracking() {
    ...
    document.addEventListener('click', (e) => {
      ...
      // activating a button from the keyboard re-renders and puts focus back
      // on the surface, which would end the mode after a single press.
      exitToolbarKeynav();
      const blockEl = e.target.closest('.ed-block');
  ...
  document.addEventListener('keydown', (e) => {
    ...
    // would have had it. Modifier presses are excluded from that rule so
    // holding Alt to repeat the entry gesture does not end the mode.
