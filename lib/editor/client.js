...
(function () {
   ...
   * screen" and the two belong in one place. `Ctrl+S` / `Cmd+S`, spelled exactly
   * as the save branch below spells it, so the two cannot drift into disagreeing
   * about what a save keystroke is.
   */
