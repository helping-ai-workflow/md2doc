...
(function () {
  ...
  // .superpowers/sdd/2026-09-07-md2doc-v3.3.0/task-4-report.md §4). The wording
  // below was driven instead by making the real blockmap search fail — grep
  // test/blockmap.test.js for 'unlocatable' — which shows this banner where the
  // '- - a' outer still shows the other one. It is a net for a shape nobody has
  // produced yet, not a path.
