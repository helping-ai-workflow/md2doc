...
(function () {
  ...
  function splitListItemAtCaret(blockEl) {
    ...
    // they run, and dropped once the new item exists.
    ...
    // After the tail has been rehomed, so a mark that travelled into the new
    // item is judged where it now lives rather than where it was collected.
    dropEmptied(leftovers);
    return newBlock;
  }
