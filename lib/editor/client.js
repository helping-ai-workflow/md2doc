...
(function () {
  ...
  // revertTableBurstAndEnd() is deliberately NOT on this list: it does not
  // set the flag itself — it delegates to switchAwayFrom()/rerenderAll(),
  // which own their own re-entrancy guards. If a fifth site is ever added,
