...
(function () {
  ...
  // also has empty textContent, and clearing innerHTML on it is data loss. Such
  // an element makes its li unsupported today, so the run-wide gate refuses the
  // key long before this is reached — this just keeps that from silently
  // becoming data loss if the supported inline set ever widens.
