...
(function () {
  ...
  if (typeof module === 'object' && module.exports) {
    module.exports = { extractBlockSource, commitEdit, commitRangeEdit, commitRangeRemoval, commitListBlockRemoval, commitBlockInsertion, planBlockMove, commitBlockMove, reorderSpanIndices, spanIndentsAreAnchored, blockMoveSeamRefusal, rollbackFailedRender, headingDepthOf, withHeadingDepth };
  ...
  async function performBlockDrop(st) {
    ...
    const seamRefusal = blockMoveSeamRefusal(
      { prev: seamDesc(live[si - 1]), next: seamDesc(live[si + 1]) },
