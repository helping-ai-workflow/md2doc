...
(function () {
  ...
  // The `pointerup` half. TASK 2 SHIPS THE DROP AS A NO-OP — this tears the
  // gesture down and does nothing else. Tasks 3-7 add the commit here, and
  // only here, against `st.sourceIndex` RE-RESOLVED in the live DOM (never
  // the node, never the id) and `st.dropTarget`.
  function endBlockDrag() {
    ...
    closeGutterMenu();
    closeInsertMenu();
    // Task 3 lands `performBlockDrop(st.sourceIndex, st.dropTarget)` here.
  }
