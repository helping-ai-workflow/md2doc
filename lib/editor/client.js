...
(function () {
  ...
  //
  //   `depth`       are the top `ops` entries still this session's own? The pop
  //                 removes exactly `ops` of them, so anything else pushing
  //                 inside the session (see openWaveEditor()'s
  ...
  /**
   * Take this session's own commits back off the document stack — bytes, dirty
