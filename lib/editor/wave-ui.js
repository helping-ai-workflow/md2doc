...
(function (root, factory) {
  ...
  function createWaveEditor(opts) {
    ...
    // (Task 14: 訊號/群組's 解散群組; Task 15: 匯出) — created disabled here so
    // the section's shape and button count are real without pretending to work.
    ...
    // ── 訊號 ──────────────────────────────────────────────────────────────
    //
    // v3.6.0 Task 12: shape-only. These four move here from the lane rail;
    // Task 14 wires their behaviour. Disabled until then.
    ...
    // v3.6.0 Task 12: shape-only, same as the 訊號 four above — Task 14 wires
    // this to `codec.ungroupLanes`.
    const groupDissolveBtn = panels.toolButton('ed-wave-group-dissolve', '解散群組',
      NOT_YET_WIRED, function () {}, groupGroup);
    groupDissolveBtn.disabled = true;
