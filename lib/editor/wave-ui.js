...
(function (root, factory) {
  ...
  function createWaveEditor(opts) {
     ...
     * a genuinely too-narrow-to-satisfy-both-at-once case. That needs a
     * handle that is really painted within `MIN_WIDTH` of the body's right
     * edge, which no fixture here produces — and "no fixture here produces
     * it" is a statement about this repo's fixtures, NOT about what a user
     * can reach, which is the distinction that let the defect above survive
     * every journey row.
     */
