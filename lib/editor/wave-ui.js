...
(function (root, factory) {
  ...
  function createWaveEditor(opts) {
     ...
     * paid for repeatedly. MEASURED, `req` dragged from row 0 to row 1 with
     * the cell cursor on it: `data-wave-cursor` 0,0 → 1,0 and
     * `data-wave-lane-range` 0,0 → 1,1, both from the trace alone.
     *
    ...
    function moveSelectedLane(step) {
      ...
      commit('move-lane', function (doc2) { return codec.moveLane(doc2, at, to); });
    }
