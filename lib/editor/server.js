...
async function createEditorServer({
  ...
  //
  // Bounded, because every re-registration is one heartbeat away from costing
  ...
  // check at all (so the comment claiming the map could not grow was half
  // true), and refusing meant that once 64 entries accumulated, a genuinely
  // swept live tab could never re-register — G5's own guard rail
