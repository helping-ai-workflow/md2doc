...
// Table cell-range selection's pure model — same "no dependency on any other
// editor module" property as selection.js; it only has to land before
// client.js reads window.md2docCellRange.
const CELL_RANGE_SRC = fs.readFileSync(path.join(__dirname, 'cell-range.js'), 'utf8');
