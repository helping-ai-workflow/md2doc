...
// all, since there is then no text to honour the gesture with. Outside
// `plainOnly`, an image still always wins over html/text -- a real image
// copy (e.g. a screenshot, or a webpage image that also carries a
// `text/html` `<img>` tag) should paste as an image on a plain Ctrl+V, not
// as markdown referencing it.
